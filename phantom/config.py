...
# Phantom never modifies the user's Reticulum config.
# If no interfaces are configured, we point users to these resources.

RETICULUM_DOCS_URL = "https://markqvist.github.io/Reticulum/manual/gettingstartedfast.html"
INTERFACE_DIRECTORY_URL = "https://directory.rns.recipes"
RMAP_URL = "https://rmap.world"
